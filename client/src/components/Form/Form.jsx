...
import gifBack from '../../img/gifBack.gif'
...
export const Form = () => {
    ...
    return (
        <main className="form-container">
            <div>
                <Link to={'/pokemons'}> <img src={gifBack} alt="not fount" className='gifBack'/> </Link>
            </div>
            ...
            <div className="pokemonData">
                <form onSubmit={event => handleSubmit(event)} className='divCreate'>
                    ...
                    <div>
                        <button type='submit' className='action-button' id='buttonCre'> Create </button>
                    </div>
